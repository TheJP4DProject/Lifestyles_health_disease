...
# Compute alpha diversity and test partial Spearman associations (with/without depth) across variables
...
# Prepare metadata and depth, load datasets, and run analyses
